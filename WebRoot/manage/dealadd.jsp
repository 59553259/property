...
<div id="content" class="col-md-12" style="margin-top:-50px">
    <div class="pageheader">
        <h2><i class="fa fa-tint" style="line-height: 48px;padding-left: 1px;"></i> 报修申请 </h2>
    </div>
    <div class="main">
        <div class="row">
            <div class="col-md-10">
                <section class="tile color transparent-black">
                    <div class="tile-header">
                        <h1><strong>报修基本信息填写</strong></h1>
                    </div>
                    <div class="tile-body">
                        <form class="form-horizontal" action="e_addDeal.action" role="form" parsley-validate id="basicvalidations">
                            ...
                            <div class="form-group">
                                <label for="fullname" class="col-sm-4 control-label">报修原因 *</label>
                                <div class="col-sm-8">
                                    <input type="text"
                            ...
                            <div class="form-group">
                                <label for="email" class="col-sm-4 control-label">报修时间 *</label>
                                <div class="col-sm-8">
                                    <input type="date"
                             ...
                             <div class="form-group">
                                <label for="email" class="col-sm-4 control-label">上门维修时间</label>
                                <div class="col-sm-8">
                                    <input type="text"
										class="form-control" name="date">
                                </div>
                             ...
                             <div class="form-group">
                                <label for="email" class="col-sm-4 control-label">维修地点</label>
                                <div class="col-sm-8">
                                    <input type="text"
										class="form-control" name="date">
                                </div>
                            ...
                            <div style="display:none;" class="form-group">
                                <label for="birthdate" class="col-sm-4 control-label">报修状态</label>
                                <div class="col-sm-8">
                                    <input type="text"
