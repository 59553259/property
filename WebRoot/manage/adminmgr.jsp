...
<html lang="zh">
	...
	<body style="font-size:20px">
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="box">
					<div class="box-header"><h2><i class="fa fa-user"></i>管理员信息管理</h2></div>
					<div class="box-content">
						<div class="row toolbar">
							...
							<div class="col-xs-8"><button type="button" data-toggle="modal" data-target="#addModal" class="btn btn-primary"><i class="fa fa-plus">增加管理员账户</i></button></div>
						</div>
