		...
		<div class="col-lg-12">
			<div class="box">
				...
				<div class="box-content">
					...
					<s:url id="url_pre" value="e_queryDeal">
						<s:param name="currentPage" value="currentPage-1"></s:param>
					</s:url>
					<s:url id="url_first" value="e_queryDeal">
						<s:param name="currentPage" value="1"></s:param>
					</s:url>
					<s:url id="url_last" value="e_queryDeal">
						<s:param name="currentPage" value="totalPage"></s:param>
					</s:url>
					<s:url id="url_next" value="e_queryDeal">
						<s:param name="currentPage" value="currentPage+1"></s:param>
					</s:url>
					<div class="clearfix">
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="form-group">
								<label for="date">请评价此次维修(选填)</label> <input type="text"
									class="form-control">
							</div>
						</div>
					</div>
